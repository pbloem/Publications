...
\title{The question of interestingness}
\date{\today}
...
\begin{abstract}
\noindent Ever since the introduction of absolute measures of information content---such as Information Entropy and Kolmogorov Complexity---there have been  criticisms of the idea that these measures capture the informal notion of  information. The argument is that the signals which, under these measures, contain the highest amount of information are of absolutely no use or interest to any observer. There is an informal notion of information content, which is not captured by these absolutes, a kind of useful or meaningful information content. We review the literature available on this topic and provide a distillation of common themes and possible connections.
\end{abstract}

\section*{Introduction}

Consider the following example. An old-fashioned, black-and-white television set is turned off. The screen is black. This signal represents a complete lack of information. It is highly predictable. Describing this signal would be very simple.
...
\section{Preliminaries: The question of complexity}

This section discusses the matter of what makes data complex. Most approaches to what makes data interesting build on these concepts. We review them here briefly, to briefly discuss our preliminaries and to define a uniform notation for the rest of the paper. 

\subsection{Entropy}

In physical systems; in probability and coding. 

\subsection{Kolmogorov Complexity}

Conditional complexity, Resource-bounded, MDL, two-part coding.

\section{Approaches to Interestingness}
...
What questions should we ask of a proposed measure?
\begin{itemize}
...
checklist per paper:
\begin{itemize}
  \item Check google scholar for citations to the paper.
  \item Walk through the citations in the paper.
\end{itemize}
