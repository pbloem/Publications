...
Separately, G\'acs, Tromp and Vit\'anyi \cite{}, built on the idea of the structure function to establish a framework of \emph{algorithmic statistics}, in the hope of founding a statistical theory not on probabilistic notions, but on combinatorical ones. This echoes Kolmogorv's own hope for the theory of information:
\begin{quotation}
