...
Lemma~\ref{lemma:invariance} in the appendix shows that this definition is invariant, so that the Kolmogorov complexity is an objective property of a function.
