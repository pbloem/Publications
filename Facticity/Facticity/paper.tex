...
Over the years one idea in particular has been proposed in many different forms. We select a description for the data by two-part coding (describing a model first, and then the data in terms of the model), and we take the complexity of only the model part as a measure of the meaningful information. If we can find a single two-part description that we can objectively call the optimal description of the data, the complexity of the data part gives us an objective property of the data. While this idea has been proposed many times in many different guises, we will, for the purposes of this paper refer to it as \emph{sophistication}\footnotemark. The general problem of how to characterize the `richness' of the information in a string rather than the plain information content (to which sophistication is but one proposed solution), we will call the `problem of interesting information'.  
...
We first provide a chronological overview of the variants of sophistication. In the body of the paper, we will define each variant rigorously, and in non-chronological order.
