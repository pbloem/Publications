...
\begin{definition}[\cite{grunwald2004shannon,vitanyi2004meaningful}]\label{definition:model-complexity}
...
\footnotetext{While in general we do not wish to make any assumptions about the origin of the data, in some cases, it can make sense to do so as a sanity check.}
