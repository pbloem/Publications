...
\begin{lemma}
There is an enumeration $\phi_1,\phi_2,\ldots$ of the partial recursive (prefix) functions, and a constant $c$ such that for all $n$ we have $G^\phi(x)<c$ for more than half of all strings $x$ of length $n$.
\end{lemma}

\begin{lemma}
There is an enumeration $\phi_1,\phi_2,\ldots$ of the partial recursive (prefix) functions such that for every constant $c$ there is an $n_0$ such that for all $n>n_0$ we have $G^\phi(x)>c$ for more than half of all strings $x$ of length $n$.
\end{lemma}
