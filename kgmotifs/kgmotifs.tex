...
\footnotetext{Note that we cannot simply think of $p^\text{EL}$ as a uniform model for graphs containing multiple links, since in we can only divide by $m!$ if we know that all triples are unique.}
